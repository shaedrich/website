...
The most useful thing now with respect to the proposal is to try out the polyfill in your framework, replacing your own reactive primitives with those from the [polyfill][signal-polyfill] and open issues such as:
