...
- remove content on sync effects
- focus on effects less in general, because they aren't well defined (too many kinds)
- do less name dropping of projects
- mention relays as a useful pattern 
- focus on the goal: for each of the three audiences, provide high level background, entice excitment about all the practical benefits of spec-signals, and provide calls to action / to try out integration / playing with the polyfill, etc
- GOAL: help people grasp the implications of the proposal: https://twitter.com/bobaekang/status/1777479259403047204
