...
Another util that enables more powerful fetch / `AbortController` management, is the _`Relay`_. (See [Signal Relays](https://www.pzuraq.com/blog/on-signal-relays) by @[pzuraq][x-pzuraq]).
