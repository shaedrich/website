...
- no need to explain the details of the proposal -- that can be a separate post (requirements / etc)
- make the text in the timeline chart bigger: https://github.com/NullVoxPopuli/website/pull/146/files#diff-43616e7ee8fb5323b7a16603833d084ee07bf8124f23319771da605d265f24fb
- maybe talk about pull-based and glitch-free behavior, emergent patterns -- could also be a separate blog post
